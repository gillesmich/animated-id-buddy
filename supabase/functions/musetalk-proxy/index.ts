...
function processBase64Chunks(base64String: string): Uint8Array {
  // Important : ne pas découper la chaîne base64, sinon on casse l'encodage
  // On nettoie puis on décode en une seule fois
